                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 ">
                        <div class="product-card product-list">
                            <a style="position: relative; width: 120px; padding: 18px; border-right: 1px solid #e1e7ec; display: table-cell; vertical-align: middle;" href="/tutor/{{ $tutor->id }}"><img src="{{ url('images/' . $tutor->image) }}" alt="Product"></a>
