            ...
            <div class="col-lg-4 col-md-4 order-md-2">
                ...
                <form method="POST" action="{{ url('create-message') }}">
                    ...
                    <div class="row">
                        ...
                        <button class="btn btn-danger col-md-6" type="button" data-toggle="modal"
                            data-target="#modalreport" style="float: right;">Report this user</button>
                    </div>
                </form>

                <div class="modal fade show" id="modalreport" tabindex="-1" role="dialog"
